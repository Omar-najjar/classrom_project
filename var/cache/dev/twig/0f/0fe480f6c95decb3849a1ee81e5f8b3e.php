...
class __TwigTemplate_c66b4722b01ce45ad11f60c46cf43351 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<td>";
        // line 123
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["cour"]) || array_key_exists("cour", $context) ? $context["cour"] : (function () { throw new RuntimeError('Variable "cour" does not exist.', 123, $this->source); })()), "nom", [], "any", false, false, false, 123), "html", null, true);
        echo "</td>
\t\t\t\t\t\t</tr>
\t\t\t\t\t\t<tr>
\t\t\t\t\t\t\t<th>Fichier</th>
...
\t</div>
    ...
    {
        return array (  238 => 139,  224 => 128,  216 => 123,  151 => 61,  145 => 58,  139 => 55,  89 => 7,  79 => 6,  59 => 3,  36 => 1,);
    }
...
", "cours/show.html.twig", "C:\\Users\\sayed\\Desktop\\Projet_Omar\\classrom_project\\templates\\cours\\show.html.twig");
    }
}
