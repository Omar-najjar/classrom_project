...
return [
    ...
    'app_classe_index' => [[], ['_controller' => 'App\\Controller\\ClasseController::index'], [], [['text', '/classe/']], [], [], []],
    'app_classe_new' => [[], ['_controller' => 'App\\Controller\\ClasseController::new'], [], [['text', '/classe/new']], [], [], []],
    'app_classe_show' => [['id'], ['_controller' => 'App\\Controller\\ClasseController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/classe']], [], [], []],
    'app_classe_edit' => [['id'], ['_controller' => 'App\\Controller\\ClasseController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/classe']], [], [], []],
    'app_classe_delete' => [['id'], ['_controller' => 'App\\Controller\\ClasseController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/classe']], [], [], []],
    'app_cours_index' => [[], ['_controller' => 'App\\Controller\\CoursController::index'], [], [['text', '/cours/']], [], [], []],
    'app_cours_admin' => [[], ['_controller' => 'App\\Controller\\CoursController::indexadmin'], [], [['text', '/cours/coursAdmin']], [], [], []],
